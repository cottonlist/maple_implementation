...
void create_exec_order()
{
	...
	for (int i = 0; i < thd1_index; ++i)
	{
		for (int j = 0; i < thd2_index; ++j)
		{
			for (int k = i + 1; k < thd1_index; ++k)
			{
				if (thd1[i].accessed_mem_addr == thd2[j].accessed_mem_addr && 
					thd1[k].accessed_mem_addr == thd2[j].accessed_mem_addr)
				{
					if (thd1[i].instruction_id == 1 && thd2[j].instruction_id == 1 && 
						thd1[k].instruction_id != 1 && thd1[k].instruction_id != thd1_index)
					{
						size[num] = 4;
						exec_order[num] = (int *)malloc(sizeof(int) * size[num]);
						exec_order[num][0] = thd1[i].index;
						exec_order[num][1] = thd2[j].index;
						exec_order[num][2] = thd1[k].index;
					...
					if (thd1[i].instruction_id == 1 && thd2[j].instruction_id == 1 && 
						thd1[k].instruction_id == thd1_index)
					{
						size[num] = 4;
						exec_order[num] = (int *)malloc(sizeof(int) * size[num]);
						exec_order[num][0] = thd1[i].index;
					...
					if (thd1[i].instruction_id == 1 && thd2[j].instruction_id != 1 && 
						thd2[j].instruction_id != thd2_index && thd1[k].index != 1 && thd1[k].instruction_id != thd1_index)
					{
						size[num] = 5;
						exec_order[num] = (int *)malloc(sizeof(int) * size[num]);
						...
						exec_order[num][3] = thd1[k].index;
						exec_order[num][4] = thd2[j].index + 1;
						fprintf(fp, "%d, %d, %d, %d, %d\n", exec_order[num][0], exec_order[num][1], 
							exec_order[num][2], exec_order[num][3], exec_order[num][4]);
						num++;
					}
					if (thd1[i].instruction_id == 1 && thd2[j].instruction_id != 1 && 
						thd2[j].instruction_id != thd2_index && thd1[k].instruction_id == thd1_index)
					{
						size[num] = 5;
						exec_order[num] = (int *)malloc(sizeof(int) * size[num]);
						exec_order[num][0] = thd2[j].index - 1;
					...
					if (thd1[i].instruction_id != 1 && thd1[i].instruction_id != thd1_index && 
						thd2[j].instruction_id == 1 && thd1[k].instruction_id == thd1_index)
					{
						size[num] = 4;
						exec_order[num] = (int *)malloc(sizeof(int) * size[num]);
						exec_order[num][0] = thd1[i].index;
					...
					if (thd1[i].instruction_id != 1 && thd1[i].instruction_id != thd1_index && thd2[j].instruction_id != 1 && 
						thd2[j].instruction_id != thd2_index && thd1[k].instruction_id == thd1_index)
					{
						size[num] = 5;
						exec_order[num] = (int *)malloc(sizeof(int) * size[num]);
